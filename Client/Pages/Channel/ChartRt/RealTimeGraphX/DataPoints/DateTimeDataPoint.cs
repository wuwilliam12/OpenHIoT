...
namespace RealTimeGraphX.DataPoints
{
    public class DateTimeDataPoint : GraphDataPoint<DateTime, DateTimeDataPoint>
    {
        ...
        /// <summary>
        /// Performs an implicit conversion from <see cref="TimeSpan"/> to <see cref="DateTimeDataPoint"/>.
        /// </summary>
        /// <param name="value">The value.</param>
        /// <returns>
        ...
        {
            return new DateTimeDataPoint(new DateTime(Value.Ticks + (other as DateTimeDataPoint).Value.Ticks));
        }
