...
{
    /// <summary>
    /// Represents a graph <see cref="int"/> value data point.
    /// </summary>
    /// <seealso cref="GraphDataPoint{int, Int32DataPoint}" />
    public class Int32DataPoint : GraphDataPoint<int, Int32DataPoint>
    {
        /// <summary>
        ...
        /// <summary>
        /// Performs an implicit conversion from <see cref="int"/> to <see cref="Int32DataPoint"/>.
        /// </summary>
        /// <param name="value">The value.</param>
        /// <returns>
        ...
        {
            return new Int32DataPoint(Value + (other as Int32DataPoint).Value);
        }
