...
namespace RealTimeGraphX.DataPoints
{
    ...
    /// </summary>
    /// <seealso cref="GraphDataPoint{double, DoubleDataPoint}" />
    public class DoubleDataPoint : GraphDataPoint<double, DoubleDataPoint>
    {
        ...
        /// <summary>
        /// Performs an implicit conversion from <see cref="double"/> to <see cref="DoubleDataPoint"/>.
        /// </summary>
        /// <param name="value">The value.</param>
        /// <returns>
        ...
        {
            return new DoubleDataPoint(Value + (other as DoubleDataPoint).Value);
        }
