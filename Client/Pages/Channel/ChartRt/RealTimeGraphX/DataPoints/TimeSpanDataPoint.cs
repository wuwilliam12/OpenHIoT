...
namespace RealTimeGraphX.DataPoints
{
    ...
    /// </summary>
    /// <seealso cref="GraphDataPoint{TimeSpan, TimeSpanDataPoint}" />
    public class TimeSpanDataPoint : GraphDataPoint<TimeSpan, TimeSpanDataPoint>
    {
        ...
        /// <summary>
        /// Performs an implicit conversion from <see cref="TimeSpan"/> to <see cref="TimeSpanDataPoint"/>.
        /// </summary>
        /// <param name="value">The value.</param>
        /// <returns>
        ...
        {
            return new TimeSpanDataPoint(Value + (other as TimeSpanDataPoint).Value);
        }
        ...
        {
            return new TimeSpanDataPoint(TimeSpan.FromMilliseconds(Value.TotalMilliseconds * (other as TimeSpanDataPoint).Value.TotalMilliseconds));
        }
